    ...
    <div className="container mx-auto p-6 max-w-7xl">
      ...
      >
        ...
        <motion.div variants={itemVariants} className="flex flex-col lg:flex-row gap-6 items-start">
                ...
                <div className="flex-1 text-center sm:text-left">
                  <div className="flex flex-col sm:flex-row sm:items-center gap-2 mb-2">
                    ...
                    <Badge variant="outline" className={`
                      ${account.role === UserRole.Labor ? 'bg-blue-900/20 text-blue-300 border-blue-800' : 'bg-amber-900/20 text-amber-300 border-amber-800'}
                    `}>
                  ...
                  <div className="flex flex-wrap gap-2 justify-center sm:justify-start mb-3">
                    <div className="flex items-center gap-1">
                      ...
                      <span className="text-gray-300 text-sm">{metadata.preferredLocation}</span>
                    </div>
                    <div className="flex items-center gap-1">
                      <DollarSign className="h-4 w-4 text-gray-400" />
                      <span className="text-gray-300 text-sm">{metadata.hourlyRate} DLT/hr</span>
                    </div>
                    <div className="flex items-center gap-1">
                      <Calendar className="h-4 w-4 text-gray-400" />
                      <span className="text-gray-300 text-sm">Joined {formatDate(account.timestamp)}</span>
                    </div>
                  </div>
                  
                  <p className="text-gray-400 mb-4 max-w-2xl">{metadata.bio}</p>
          ...
          <Card className="w-full lg:w-72 bg-gray-950 border-gray-800">
            <CardHeader className="pb-3">
              <CardTitle className="text-lg text-white">Rating & Stats</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <div>
                <div className="flex items-center justify-between mb-1">
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="text-white font-medium ml-1">{account.rating.toFixed(1)}</span>
                  </div>
                </div>
                <Progress value={(account.rating / 5) * 100} className="bg-gray-800 h-2">
                  <div className="h-full bg-gradient-to-r from-yellow-500 to-yellow-400 rounded-full" />
                </Progress>
                <div className="text-xs text-gray-400 mt-1">Based on {account.rating_count} reviews</div>
              </div>
              ...
              <div className="pt-2 space-y-2">
                <div className="flex justify-between items-center">
                  ...
                  <Badge className="bg-gray-800">{metadata.certifications?.length || 0}</Badge>
                </div>
                <div className="flex justify-between items-center">
                  <div className="flex items-center gap-2">
                  ...
                  <Badge className="bg-gray-800">{metadata.projectHistory?.length || 0}</Badge>
                </div>
                <div className="flex justify-between items-center">
                  <div className="flex items-center gap-2">
                  ...
                  <Badge className="bg-gray-800">{metadata.languages?.length || 0}</Badge>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <motion.div variants={itemVariants}>
          <Tabs defaultValue="skills" className="w-full">
            <TabsList className="bg-gray-900 border border-gray-800">
              <TabsTrigger value="skills" className="data-[state=active]:bg-purple-900/30 data-[state=active]:text-purple-200">
                Skills & Experience
              </TabsTrigger>
              <TabsTrigger value="projects" className="data-[state=active]:bg-purple-900/30 data-[state=active]:text-purple-200">
                Project History
              </TabsTrigger>
              <TabsTrigger value="certifications" className="data-[state=active]:bg-purple-900/30 data-[state=active]:text-purple-200">
                Certifications
              </TabsTrigger>
            </TabsList>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <Card className="bg-gray-950 border-gray-800">
                  <CardHeader>
                    ...
                    <CardDescription>Communication capabilities</CardDescription>
                  </CardHeader>
                  <CardContent>
                ...
                <Card className="bg-gray-950 border-gray-800">
                  <CardHeader>
                    ...
                    <CardDescription>Current work status and preferences</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div className="flex items-center justify-between">
                      <span className="text-gray-300">Status</span>
                      <Badge className={`
                        ${account.active ? 'bg-green-900/20 text-green-300 border-green-800' : 'bg-red-900/20 text-red-300 border-red-800'}
                      `}>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-gray-200">{metadata.preferredLocation}</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-gray-300">Rate</span>
                      <span className="text-gray-200">{metadata.hourlyRate} DLT/hour</span>
                    </div>
                  </CardContent>
                </Card>
              </div>
            ...
            <TabsContent value="projects" className="mt-4">
              <Card className="bg-gray-950 border-gray-800">
                <CardHeader>
                  ...
                  <CardDescription>Past work and achievements</CardDescription>
                </CardHeader>
                <CardContent>
                    ...
                    {metadata.projectHistory?.map((project, index) => (
                      <div key={index} className="border-b border-gray-800 pb-4 last:border-0 last:pb-0">
                        <div className="flex justify-between items-start mb-2">
                          ...
                          <Badge variant="outline" className="bg-purple-900/10 text-purple-300 border-purple-800">
                            {project.duration}
                          </Badge>
                        </div>
                      ...
                      <div key={index} className="p-4 border border-gray-800 rounded-lg bg-gray-900">
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-400">Verified credential</p>
                          </div>
                        </div>
                      </div>
                    ))}
        ...
        >
          <Card className="bg-gray-950 border-gray-800">
            <CardContent className="p-6">
              ...
              <Progress value={85} className="h-1 mt-4 bg-gray-800">
            ...
            <CardContent className="p-6">
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <h3 className="text-2xl font-bold text-white mt-1">{metadata.projectHistory?.length || 0}</h3>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <h3 className="text-2xl font-bold text-white mt-1">{metadata.skillsets?.length || 0}</h3>
                </div>
                <div className="p-2 bg-purple-900/20 rounded-lg">
            ...
            <CardContent className="p-6">
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <h3 className="text-2xl font-bold text-white mt-1">1234 DLT</h3>
                </div>
